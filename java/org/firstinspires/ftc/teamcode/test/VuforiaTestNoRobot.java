...
public class VuforiaTestNoRobot extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        updateTelemetry(telemetry);
            ...
            moveToward(beacons.get(0), 10000);
                /*
    ...
    public void moveToward(VuforiaTrackable beacon, long time)
    {
        telemetry.addData("VUFORIA ", "made it to moveToward()");
        updateTelemetry(telemetry);
        time += timer.time();
        telemetry.addData("VUFORIA ", "timer");
        updateTelemetry(telemetry);
