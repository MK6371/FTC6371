...
public class ForwardLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Holonomic.move(0, 0, lSpeed, lSpeed, robot);
        sleep(50);
        Holonomic.move(-lSpeed, -lSpeed, lSpeed, lSpeed, robot);

        while(forwardTimer.time() < 5000 && opModeIsActive()) {
            Holonomic.move(-lSpeed - correction, -lSpeed - correction, lSpeed - correction, lSpeed - correction, robot);
