...
public class Holonomic {    /*TODO: Holonomic just provides functionality, it shouldn't be the one being called one. Should I turn
                                it into an interface and implement it in HardwareHolonomic instead? Or should I just move all the functions completely?*/
